namespace Dazinator.Extensions.DependencyInjection
{
    ...
    public class ReRoutingServiceProvider : IServiceProvider
    {
        ...
        private readonly Dictionary<Type, IServiceProvider> _routes = new Dictionary<Type, IServiceProvider>();

        private readonly HashSet<Type> _openGenericServiceTypes = new HashSet<Type>();
